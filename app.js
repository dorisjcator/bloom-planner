...
var TB=[
  {k:'dash',l:'\uD83C\uDF38 Home'},{k:'appt',l:'\uD83D\uDCC5 Appts'},
  {k:'event',l:'\uD83C\uDF89 Events'},{k:'task',l:'\u2705 Tasks'},
  {k:'trip',l:'\u2708\uFE0F Trips'},{k:'budget',l:'\uD83D\uDCCA Budget'},
  {k:'cal',l:'\uD83D\uDCC6 Calendar'}
];
var BC=[
...
function rBud(){
  ...
  for(var j=0;j<BC.length;j++){
    ...
    // Progress bar
    if(catPlan>0){
      var pColor=catPct>100?'#e11d48':catPct>80?'#d97706':bc.c;
      h+='<div class="bpbar"><div class="bpfill" style="width:'+catPct+'%;background:'+pColor+'"></div></div>';
    }
    ...
    // Existing lines with paid toggle and spent input
